        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="index.php?p=tabel_penyakit">
                  <p><img class="" src="img/cd-icon-username.svg"> Tabel Penyakit</p>
                </a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link" href="index.php?p=tabel_gejala">
                  <p><img class="" src="img/cd-icon-username.svg"> Tabel Gejala</p>
                </a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link" href="index.php?p=tabel_aturan">
                  <p><img class="" src="img/cd-icon-username.svg"> Tabel Aturan</p>
                </a>
              </li>
            </ul>
          </div>
