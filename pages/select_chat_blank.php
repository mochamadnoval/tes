...
<body style="background: #f3f3f3;">
  ...
  <div class="row">
      <div class="col-4 kotak-list-chat">
        ...
        <?php
          $konsultasi = $konsul->tampilKonsulUserById($_SESSION['id']);


         ?>

         <?php foreach ($konsultasi as $row): ?>
           <a href="select_chat_blank.php?id_konsul=<?= $row['id_konsultasi'] ?>"  >
          ...
          <button type="button" class="selesai-konsul" data-toggle="modal" data-target="#delete_konsul_<?= $row['id_konsultasi'] ?>" data-whatever="@getbootstrap">Selesai Konsul</button>

           <!-- Modal Delete Konsul -->
           <div class="modal fade" id="delete_konsul_<?= $row['id_konsultasi'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
             <div class="modal-dialog" role="document">
               <div class="modal-content">
                 ...
                 <div class="modal-body">
                  <p>Anda yakin ingin selesai konsul dengan Dr. <?= $row['nama_user'] ?></p>
                 </div>
                 <div class="modal-footer">
                   <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                   <a href="../process/konsul/gantiStatusFinishUser_proses.php?id=<?= $row['id_konsultasi'] ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                 </div>
               </div>
             </div>
           </div>
